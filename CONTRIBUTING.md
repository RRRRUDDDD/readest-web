...
For the best experience to build Readest for yourself, use a recent version of Node.js.
...
This project is a monorepo. The code for the `readest-app` is in the `apps/readest-app` directory.
